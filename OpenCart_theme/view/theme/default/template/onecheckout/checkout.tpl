...
<script>
	window.onload = setTimeout(function(){ buttonConfirmorder(); }, 1000);

</script>

<?php } ?>
<div id="content" class="checkout form-stlr" style="position: relative;"><?php echo $content_top; ?>
  ...
  <div class="slider-left" style="width: 100%">
    ...
    <div id="payment-address" style="display: none">
      ...
      <div class="onecheckout-content"></div>
		<script>
			window.onload =	setTimeout("$('#button').css('margin-bottom', '479px !important');", 1000);
		</script>
		<style>

			.form-stlr .buttons .right {
  ...
  <div class="slider-right new-class">
    <div id="confirm" style="display: block" 2>
...
<style>
	...
	.form-stlr input[type="text"],  .form-stlr input[type="password"], .form-stlr textarea {
		height: 38px;
		background: #e1eefe;
		border-radius: 10px;
		border: 0;
